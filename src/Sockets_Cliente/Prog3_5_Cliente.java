...
//programa que simula un juego, el cliente intenta adivinar el numero que genera el servidor
public class Prog3_5_Cliente {
	...
	//variables
		...
		public static void main(String[] args) {
			Prog3_5_Cliente cliente = new Prog3_5_Cliente();
